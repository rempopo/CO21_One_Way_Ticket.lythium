...
TOPIC(true,"Фонетический алфавит")
	[
		...
		,"<br /><font color='#12C4FF' size='14'>Deutsch</font>"
		, "A - Anton", "B - Berta", "C - Casar", "D - Dora", "E - Emil", "F - Friedrich", "G - Gustav", "H - Heinrich", "I - Ida", "J - Julius", "K - Kaufmann", "L - Ludwig", "M - Martha"
		, "N - Nordpol", "O - Otto", "P - Paula", "Q - Quelle", "R - Richard", "S - Siegfried", "T - Theodor", "U - Ulrich", "V - Viktor", "W - Wilhelm", "X - Xanthippe", "Y - Ypsilon", "Z - Zeppelin"
	] joinString "<br />" 
END
