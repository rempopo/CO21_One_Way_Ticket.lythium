...
<br />Таким образом перед взводом Бундесвера на FOB Fabian стоит задача в кратчайшие сроки провести разведку боем с целью найти и уничтожить миномётную позицию, и, по возможности, прочие силы противника. К сожалению у нас нет тяжелой артиллерии наготове, а наши минометы слишком далеко, чтобы гарантировано поразить цель без корректировщиков на месте."
END

TOPIC("А. Враждебные силы:")
"Боевики Талибана - иррегулярные силы:
<br />   предположительно до роты пехотинцев, усиленной миномётами и тяжелыми пулемётами."
END
...
"Местоположение минометной позиции определно с точностью до 300 метров, поэтому вам стоит сконцентрировать усилия на близлежащих кампаундах.
<br />
<br />Вы можете выполнять задачи в любом порядке. 
<br />
